...
function calc() {
    ...
    function initLocalSrorage(selector, activeClass) {
    ...
    initLocalSrorage("#gender div", 'calculating__choose-item_active');
    initLocalSrorage(".calculating__choose_big div", 'calculating__choose-item_active');
...
window.addEventListener('DOMContentLoaded', function() {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-08-11');
